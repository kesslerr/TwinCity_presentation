...
%\logo{\includegraphics[height=0.4in]{./images/hdalogo.jpg}}
...
\title[Anomaly Detection]{A Primer on Anomaly Detection Strategies in Urban Traffic}
...
\author[Roman Kessler]{
	...
	\Large
	Roman Kessler\\
    \footnotesize \href{mailto:roman.kessler@stud.h-da.de}{roman.kessler@stud.h-da.de}
\end{tabular}
\vspace{-4ex}}
...
\institute{
	...
	\begin{figure}
		\centering
        \includegraphics[height=0.55in]{./images/hdalogo.jpg}
	\end{figure}
	\vskip 5pt
